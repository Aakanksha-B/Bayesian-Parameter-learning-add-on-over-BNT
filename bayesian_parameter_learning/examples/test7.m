...
bnet.CPD{3} = tabular_CPD(bnet,3,'CPT',[0.7,0.2,0.1,0.2,0.3,0.8,0.9,0.8]);
...
% end
samples=[
    2     1     2     1     2     1     1     1     1     1     1     2     1     1     2     2     1     1     1   2;
     2     2     1     2     2     2     1     2     1     2     2     2     2     2     1     2     2     2     1  2;
...
train_samples = samples(:,[1:15]);%51:70]);
test_samples = samples(:,5:20);
bnet=learn_all_parameters(bnet, train_samples,nu,alpha);
test(bnet,test_samples);

for k =bnet.dnodes
    cpt = get_field(bnet.CPD{k},'cpt')
